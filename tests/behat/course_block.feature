...
Feature: HTML blocks in a course
  ...
  Scenario: Adding HTML block in a course
    ...
    Then I should see "First block content" in the "First block header" "block"
    And I should see "Second block content" in the "Second block header" "block"
    And I log in as "student1"
    And I am on "Course 1" course homepage
    And I should not see "First block header"
    And I should not see "Second block header"