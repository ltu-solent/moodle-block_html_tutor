...
/**
 * Strings for component 'block_html_tutor', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['html_tutor:addinstance'] = 'Add a new HTML tutor block';
$string['html_tutor:myaddinstance'] = 'Add a new HTML tutor block to Dashboard';
$string['leaveblanktohide'] = 'leave blank to hide the title';
$string['newhtmltutorblock'] = '(new HTML tutor block)';
$string['pluginname'] = 'HTML tutor';
